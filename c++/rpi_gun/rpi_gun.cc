...
#include "tensorflow/contrib/lite/examples/rpi_gun/bitmap_helpers.h"
#include "tensorflow/contrib/lite/examples/rpi_gun/get_top_n.h"
...
int main(int argc, char** argv) {
  return tflite::rpi_gun::Main(argc, argv);
}
